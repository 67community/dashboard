  ...
  return (
    <div>
      ...
      <div className="enter-1" style={{
        ...
        {/* Market pills — desktop only */}
        <style>{`.market-pills { display:flex !important; } @media(max-width:640px){.market-pills{display:none !important;}}`}</style>
        <div className="market-pills" style={{ display:"flex", flexWrap:"nowrap", gap:4, flex:1, overflowX:"auto", scrollbarWidth:"none" }}>
          {market.map((m, i) => {
            ...
            const logo = sym === "BTC"
              ...
              : sym === "SOL"
              ? <svg width="12" height="12" viewBox="0 0 32 32"><circle cx="16" cy="16" r="16" fill="#9945FF"/><path d="M9 21h14l-2.5 3H6.5L9 21zm0-6h14l-2.5 3H6.5L9 15zm2.5-6h14l-2.5 3H9l2.5-3z" fill="white"/></svg>
