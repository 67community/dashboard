...
function VideoTile({ v, large = false }: { v: YoutubeVideo; large?: boolean }) {
  ...
  return (
    <a href={v.video_url} target="_blank" rel="noopener noreferrer"
      ...
      <div style={{ borderRadius:12, overflow:"hidden", border:"1.5px solid var(--separator)", minWidth:220, width:220, flexShrink:0, background:"var(--card)", transition:"transform 0.15s" }}
